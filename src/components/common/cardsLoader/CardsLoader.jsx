  ...
  render() {
    return (
      ...
      >
        ...
        <rect x="2" y="432" rx="0" ry="0" width="100" height="71" />
        <rect x="120" y="432" rx="3" ry="3" width="90" height="10" />
        <rect x="120" y="454" rx="3" ry="3" width="90" height="10" />
        <rect x="120" y="476" rx="3" ry="3" width="52" height="10" />
        <rect x="3" y="514" rx="3" ry="3" className="w-100" height="20" />
        <rect x="3" y="544" rx="3" ry="3" className="w-100" height="20" />
        <rect x="3" y="574" rx="3" ry="3" className="w-100" height="20" />
        <rect x="3" y="604" rx="3" ry="3" className="w-100" height="20" />
      </ContentLoader>
    );
  }
}
