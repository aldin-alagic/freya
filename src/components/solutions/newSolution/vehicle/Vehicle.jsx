...
export class Vehicles extends React.PureComponent {
  static propTypes = {
    ...
    onChangeVehicles: PropTypes.func.isRequired,
  };

  render() {
    const { values, onChangeVehicles, onChange, onSelectChange } = this.props;
          ...
          <div className="card-body">
            ...
            {values.vehicles.length > 1 ? (
              <button
                ...
                onClick={() => onChangeVehicles("remove")}
              >
                Remove vehicle
              </button>
            ) : (
