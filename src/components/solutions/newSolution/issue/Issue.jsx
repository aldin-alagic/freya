...
export function Issue() {
  ...
  const { type, option, code, description, attachments } = useSelector(
  ...
  const {
    ...
    defaultValues: { issueTypeOption: option, issueCode: code, issueDescription: description },
  });

  const onSubmit = ({ issueType, issueTypeOption, issueCode, issueDescription }) => {
    const issue = {
      step: 2,
      status: "process",
      issue: {
