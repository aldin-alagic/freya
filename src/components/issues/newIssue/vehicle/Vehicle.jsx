...
export function Vehicle() {
  ...
  const transmission = useSelector(
    (state) => state.entities.issues.newIssue.transmission
  );
  const fuelType = useSelector(
    (state) => state.entities.issues.newIssue.fuelType
  );
  ...
  const [vehicles, setVehicles] = useState([
    ...useSelector((state) => state.entities.issues.newIssue.vehicles),
  ]);
